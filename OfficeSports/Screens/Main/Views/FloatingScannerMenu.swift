//
//  FloatingScannerMenu.swift
//  OfficeSports
//
//  Created by Øyvind Hauge on 17/09/2022.
//

import UIKit

// MARK: - Floating Scanner Menu Delegate

protocol FloatingScannerMenuDelegate: AnyObject {
}

final class FloatingScannerMenu: UIView {
